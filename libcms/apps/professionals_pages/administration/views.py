...
@login_required
@permission_required_or_403('professionals_pages.add_page')
...
#    pages = [page['page'] for page in pages_dict.values()]
    ...
    return render(request, 'professionals_pages/administration/pages_list.html', {
        'parent': parent,
...
@login_required
@permission_required_or_403('professionals_pages.change_page')
...
@login_required
@permission_required_or_403('professionals_pages.delete_page')
...
def page_up(request, id):
    ...
    page.up()
    if page.parent_id:
        return redirect('professionals_pages:administration:pages_list', parent=page.parent_id)
    else:
        return redirect('professionals_pages:administration:pages_list')
