...
urlpatterns = (
    ...
    re_path(r'^pages/permissions/(?P<id>\d+)/$', views.page_permissions, name="page_permissions"),
    re_path(r'^pages/assign_page_permissions/(?P<id>\d+)/$', views.assign_page_permissions, name="assign_page_permissions"),
