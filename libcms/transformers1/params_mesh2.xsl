...
<xsl:param name="cgi.script.URL" select="''"/>
...
<xsl:param name="help.URL" select="'http://www.arbicon.ru/services/help_mesh.asp'"/>
...
<xsl:param name="follow.subject" select="false()"/>
<xsl:param name="follow.header" select="false()"/>

<xsl:param name="follow.attrs" select="'[1,12,4,3]'"/>
