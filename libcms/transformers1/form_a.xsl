...
<xsl:template match="target">
  <html>
    ...
    <xsl:element name="body">
      <xsl:if test="string-length($onload)">
...
<xsl:template name="form.body">
  <xsl:param name="db"/>
  <tr>
	<td class="text" colspan="2" align="center"><div class="outer-border"><div class="search-form">
...
<xsl:template name="form.header">
  <xsl:choose>
    ...
    <a href="/participants.html" class="menu">Участники</a>|
    <a href="http://demo.arbicon.ru" class="menu">Поиск</a>|
    <a href="#" onclick="openDialog()" class="menu">Классификаторы</a>|
